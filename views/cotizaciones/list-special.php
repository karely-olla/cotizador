    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Lista de Cotizaciones Especiales</h3>
        ...
        <div class="box-body">
          <div class="panel panel-default">
            ...
            <div class="panel-body">               
                <div class="tbl_cots">
                  <table class="table table-condensed table-hover table-striped" id="tbl_cots_especial">
                    <thead>
                      <tr>
                        <th>#</th>
                        <th>Folio</th>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-lg" role="document">
    <form method="POST" id="frm_edit_cotizacion_special">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title"></h4>
...
<script src="<?= link ?>js/backjs/cotizacion-special.js"></script>
