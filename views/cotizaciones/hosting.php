      ...
      <div class="box box-success">
        ...
        <div class="box-body">
        	<div class="panel panel-danger">
              ...
              <h3 class="col-lg-8 col-md-8 col-sm-8 col-xs-12">Generar Cotizaciones (Hospedaje) <i class="fa fa-hotel"></i></h3>
              <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="input-group input-search">
                  <input type="text" id="buscar" onkeyup="buscar(event,this.value,'Hosting')" placeholder="Buscar Grupos" class="form-control">
                  <div class="input-group-addon btn-group-search" onclick="buscar(event,document.getElementById('buscar').value,'Hosting')"><i class="fa fa-search"></i></div>
              ...
              <div class="clearfix"></div>
    			  ...
    			  <div class="panel-body">
    		        <form method="POST" name="frm_hospedaje" id="frm_hospedaje" class="frm_cotizador">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          ...
                          <div class="step_one col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="form-group"><label for="n_int">Cuadruple:</label>
